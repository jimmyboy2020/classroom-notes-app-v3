-- Drop existing tables if they exist, in reverse order of dependency, to ensure a clean setup
...
CREATE TABLE IF NOT EXISTS notes (
  ...
  modified_by_student BOOLEAN NOT NULL DEFAULT FALSE -- Added this field
);